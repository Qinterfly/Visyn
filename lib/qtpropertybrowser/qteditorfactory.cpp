...
class QtDoubleSpinBoxFactoryPrivate : public EditorFactoryPrivate<CustomDoubleSpinBox>
{
...
void QtDoubleSpinBoxFactoryPrivate::slotPropertyChanged(QtProperty* property, double value)
{
    ...
    if (it == m_createdEditors.cend())
        return;
    for (CustomDoubleSpinBox* editor : it.value())
    {
        if (editor->value() != value)
        {
            editor->blockSignals(true);
...
/*! \class QtDoubleSpinBoxFactory
    ...
    \brief The QtDoubleSpinBoxFactory class provides CustomDoubleSpinBox
...
{
    CustomDoubleSpinBox* editor = d_ptr->createEditor(property, parent);
    editor->setSingleStep(manager->singleStep(property));
    ...
    connect(editor, &CustomDoubleSpinBox::valueChanged,
