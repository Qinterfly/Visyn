...
/*!
    Set the font of the tree widget
*/
void QtTreePropertyBrowser::setTreeWidgetFont(QFont const& font)
{
    d_ptr->treeWidget()->header()->setFont(font);
    d_ptr->treeWidget()->setFont(font);
}
